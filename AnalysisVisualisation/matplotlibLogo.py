...
import numpy as np
import matplot.cm as cm 

from matplotlib.pyplot import figure, show, rc
from matplotlib.patches import Ellipse

# Create a square figure on which to plaace the plot
...
N = 20
theta = np.arrange(0.0, 2*np.pi, 2*np.pi/N)
...
bbox_white = dict(boxstule="round, pad0.9", fc="1", alpha=0.9)
...
ax.annotate('Matplot lib and the Python Ecosystem for scientific Computing',
        xy(.5,.93),
        xycoords='figure fraction',
